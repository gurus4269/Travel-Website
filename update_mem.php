<?php
    ...
    $input = "";
    if ($result = mysqli_query($link, "SELECT * FROM user where id = '$id'")) {
        while ($aaa = mysqli_fetch_assoc($result)) {
            $name =$aaa["name"];
            $password = $aaa["password"]; 
            $email = $aaa["email"]; 
            $permission = $aaa["permission"];
            if($permission == 1)
                {$permission2 ="買家";}
                ...
                {$permission2 ="管理者";}
            $input .= "<tr><td>原資料</td><td>" . $name . "</td><td>" . $id . "</td><td>" . $password . "</td><td>" . $email . "</td><td>" . $permission2 . '</td></tr>';
        }
...
<body>
   ...
   <!--- <section class="same-section-spacing bg-banner">
    ...
    <div class="container">
        ...
        <form class="form-horizontal" role="form" action="input.php" method="POST" id = "update_mem_form">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div class="form-group">
                            <td><input type="text" name="us_na" value="<?php echo $name ?>"></td>
                        </div>
                        <div class="form-group">
                            <td><input type="text" readonly = "readonly" name="us_id" value="<?php echo $id ?>"></td>
                        </div>
                        <div class="form-group">
                            <td><input type="text" name="us_pwd" value="<?php echo $password ?>"></td>
                        </div>
                        <div class="form-group">
                            <td><input type="text" name="us_email" value="<?php echo $email ?>"></td>
                        </div>
                        <div class="form-group">
                            <td>
                                <input type="radio"  name="us_permission" value="1"<?php if($permission == 1){echo "checked";}?>>當一個買家就好
                                <input type="radio"  name="us_permission" value="2"<?php if($permission == 2){echo "checked";}?>>同時成為賣家
                            </td>
                        </div>
                    </tr>
                    <tr>
